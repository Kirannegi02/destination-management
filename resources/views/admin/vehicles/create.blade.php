...
<div class="card">
    ...
    <form action="{{ route('admin.vehicles.store') }}" method="POST" style="padding:20px;">
        ...
        <div style="margin-bottom:20px;"><label>Default price per km</label><input type="number" name="default_price_per_km" value="{{ old('default_price_per_km') }}" step="0.01" min="0" style="width:100%;padding:10px;border:2px solid #e2e8f0;border-radius:8px;"></div>
        <div style="margin-bottom:20px;"><label>Currency</label><input type="text" name="currency" value="{{ old('currency','INR') }}" style="width:100%;padding:10px;border:2px solid #e2e8f0;border-radius:8px;"></div>
        ...
        <div style="margin-bottom:20px;"><label>Sort order</label><input type="number" name="sort_order" value="{{ old('sort_order',0) }}" min="0" style="width:100%;max-width:120px;padding:10px;border:2px solid #e2e8f0;border-radius:8px;"></div>
