            ...
            <div style="margin-bottom: 30px;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="meal_type" 
                            ...
                            @foreach($mealTypes as $key => $label)
                                <option value="{{ $key }}" {{ old('meal_type', $meal->meal_type) == $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div class="form-group">
                        ...
                        <input type="number" 
                               name="price_inr" 
                               value="{{ old('price_inr', $meal->price_inr) }}"
                               step="0.01"
                               min="0"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               name="local_currency" 
                               value="{{ old('local_currency', $meal->local_currency) }}"
                               maxlength="10"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               name="local_price" 
                               value="{{ old('local_price', $meal->local_price) }}"
                               step="0.01"
                               min="0"
