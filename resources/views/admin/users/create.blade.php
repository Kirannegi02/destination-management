...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('admin.users.index', ['status' => request('status', 'pending')]) }}" 
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" style="max-width: 900px;">
            @csrf
