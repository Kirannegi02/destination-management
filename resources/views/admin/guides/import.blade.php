...
@section('title', 'Bulk Import Guides')
@section('page-title', 'Bulk Import Guides')
...
@section('content')
    <div class="card">
        <div class="card-header" style="align-items: flex-start;">
            <div>
                ...
                <p style="color: #718096; font-size: 14px; margin-top: 4px;">
                    Supported formats: CSV, XLS, XLSX. Start from the sample to avoid column issues.
                </p>
            </div>
            <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                <a href="{{ route('admin.guides.import.sample', ['format' => 'csv']) }}"
                   style="padding: 8px 12px; background: #4299e1; color: white; border-radius: 6px; text-decoration: none; font-size: 14px;">
                    Download CSV Sample
                </a>
                <a href="{{ route('admin.guides.import.sample', ['format' => 'xls']) }}"
        ...
        <div style="padding: 20px; display: grid; grid-template-columns: 2fr 1fr; gap: 20px; align-items: start;">
            <form action="{{ route('admin.guides.import') }}" method="POST" enctype="multipart/form-data" style="background: #f7fafc; padding: 16px; border-radius: 10px; border: 1px solid #e2e8f0;">
                @csrf
            ...
            <div style="background: white; border: 1px solid #e2e8f0; border-radius: 10px; padding: 16px;">
                ...
                <p style="color: #4a5568; font-size: 14px; margin-bottom: 10px;">
                    Required: <strong>title</strong>, <strong>status</strong>. Use HH:MM for times and YYYY-MM-DD for dates.
                </p>
